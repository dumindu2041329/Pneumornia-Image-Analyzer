  ...
  return (
    <div className="w-full">
      {!selectedFile ? (
        ...
        <div className="relative border-2 border-blue-200 rounded-xl p-6 bg-blue-50">
          <button
            onClick={onClear}
            disabled={disabled}
            className="absolute top-4 right-4 p-2 bg-white rounded-full shadow-md hover:bg-gray-100 transition disabled:opacity-50 disabled:cursor-not-allowed"
